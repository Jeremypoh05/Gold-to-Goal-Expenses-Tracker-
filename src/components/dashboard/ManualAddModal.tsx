...
// CHANGED (Phase A follow-up): AISuggestCard extracted to the shared barrel so the
// voice Edit view reuses the same "Suggested" card.
import { useConfirm, TagChip, AISuggestCard, type AISuggestion } from '@/components/shared';
...
// AI suggest — the "Suggested" card (category pill + tappable tag chips + Apply all)
// now lives in components/shared/AISuggestCard so the voice Edit view reuses it.
// The debounced suggestExpenseMeta call + apply handlers stay in the form state below.
